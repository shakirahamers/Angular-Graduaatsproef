            ...
            <div class="flex items-center">
              <div class="relative">
                ...
                <input name="start" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
                  bsDatepicker placeholder="Select start date" [(ngModel)]="startDatum">
              </div>
              ...
              <div class="relative">
                ...
                <input name="end" type="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
                  bsDatepicker placeholder="Select end date" [(ngModel)]="eindDatum">
              </div>
            </div>
            <div class="flex flex-col justify-center items-center h-full">
