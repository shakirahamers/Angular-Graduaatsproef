...
<div class="container flex mx-auto">
  <div class="flex items-center mb-6">
    ...
    <h3 class="text-center mx-auto ml-3 h-10 w-35 bg-gray-400 text-white border-gray-300 rounded-lg border">&nbsp; {{ parkingcontract?.aantalBezettePlaatsen || 0 }} / {{ parkingcontract?.aantalPlaatsen || 0 }} &nbsp;</h3>
  </div>
